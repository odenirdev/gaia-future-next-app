            ...
            <section className="flex flex-col gap-8">
              <div className="space-y-2 max-w-xl">
                ...
                <p className="text-md md:text-lg text-zinc-400">
                  ...
                  software preocupada com o futuro verde do planeta.
                </p>
              </div>
              ...
              <section>
                <div className="space-y-4">
                  ...
                  <p className="max-w-[600px] text-zinc-500 text-md md:text-lg">
                    ...
                    excelência e inovação em tudo o que fazemos, sempre com o
                    objetivo de promover um impacto positivo e sustentável.
                  </p>
                </div>
